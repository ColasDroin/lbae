...
class SmzMLobj:
    ...
    def get_mz_vals(
        ...
        mz_resolution: float, default = None
            ...
            If None (recommended) it extracts the mz_vals
        ...
        if mz_resolution not in self._mz_vals_at_res:
            # This case is triggered when the data at a certain resolution was never loaded
    ...
    def change_resolution(self, mz_resolution: float, inplace: bool = True) -> SmzMLobj:
        """Change the resolution of the spectra. It cannot be reverted.
    ...
    def plot_spectra(
        ...
        **plotkwargs: Dict[str, Any],
        ...
        ax:
            It produces a matplotlib plot and return the axes
        """
        kwargs: Dict[str, Any] = {"facecolor": "none", "lw": lw}
        kwargs.update(plotkwargs)
