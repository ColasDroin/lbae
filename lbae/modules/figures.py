...
class Figures:
    ...
    def __init__(self, maldi_data, atlas):
        ...
        self.dic_fig_contours = return_db_object(
        ...
        self.dic_normalization_factors = return_db_object(
    ...
    def compute_figure_bubbles_3D(
        ...
        array_x, array_y, array_z, array_c = return_db_object(
            "figures/3D_page",
